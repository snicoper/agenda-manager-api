...
namespace AgendaManager.Domain.UnitTests.ResourceTypes.ResourceTypeAggregate;
...
public class ResourceTypeCreateTests
{
    ...
    [Fact]
    public void Create_ShouldSuccess_WhenCreateResourceTypeWithRoleId()
    {
        // Arrange
        var resourceType = ResourceTypeFactory.CreateResourceType(roleId: RoleId.Create());
