...
public sealed class AppointmentManager(
    ...
    ICalendarWeekDayAvailabilityPolicy weekDayAvailabilityPolicy,
    ...
    IServiceRequirementsPolicy serviceRequirementsPolicy)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // 2. Validate calendar weekday availability
        var weekDayResult = weekDayAvailabilityPolicy.IsAvailable(calendar, period);
        if (weekDayResult.IsFailure)
        {
            return weekDayResult.MapToValue<Appointment>();
        }
        ...
        // 9. Add appointment to repository.
        ...
        CancellationToken cancellationToken)
    {
        ...
        // 3. Validate calendar weekday availability
        var weekDayResult = weekDayAvailabilityPolicy.IsAvailable(calendar, period);
        if (weekDayResult.IsFailure)
        {
            return weekDayResult.MapToValue<Appointment>();
        ...
        // 4. Validate state is valid for update.
        ...
        // 5. Validate calendar and holidays.
        ...
        // 6. Validate appointment overlapping if required.
        var overlapResult = await overlapPolicy.IsOverlappingAsync(
            calendar: calendar,
            period: period,
            cancellationToken: cancellationToken);
        ...
        // 7. Validate resource availability if required.
        var resourceResult = await resourceAvailabilityPolicy.IsAvailableAsync(
            calendar: calendar,
            resources: resources,
            period: period,
        ...
        // 8. Validate service requirements.
        ...
        // 10. Update appointment in repository.
